...
**Bug Fixes:**
- **Dice Face Transitions** — Dice now tumble through 3 random faces before settling on the final result, creating a more realistic rolling appearance
...
- **Dice Spawn Position** — Dice now spawn near center of screen and drop from above with natural spread, instead of spawning from corners
